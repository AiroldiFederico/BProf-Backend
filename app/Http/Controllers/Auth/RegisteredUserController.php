...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $request->validate(
            ...
            'subject' => ['required', 'string', 'max:255','in:Matematica, Italiano, Arte, Storia, Geografia, Scienze, Inglese, Musica, Educazione Fisica, Tecnologia, Religione, Informatica'],
